...
r  = requests.get("https://coinmarketcap.com/currencies/celer-network/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('celer-network price from 2014')
