...
r  = requests.get("https://coinmarketcap.com/currencies/davinci-coin/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('davinci-coin price from 2014')
