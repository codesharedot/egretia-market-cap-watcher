...
r  = requests.get("https://coinmarketcap.com/currencies/groestlcoin/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('groestlcoin price from 2014')
