...
r  = requests.get("https://coinmarketcap.com/currencies/polymath-network/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('polymath-network price from 2014')
