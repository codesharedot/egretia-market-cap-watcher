...
r  = requests.get("https://coinmarketcap.com/currencies/litecoin-cash/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('litecoin-cash price from 2014')
